...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/finalhandler/index.js";
...
<p>fallback to status code on response</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        status = getResponseStatusCode(res)
...
<p>respect headers from error</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        headers = getErrorHeaders(err)
      }
...
<p>not found</p>
      ...
      msg = <span class="hljs-string">'Cannot '</span> + req.method + <span class="hljs-string">' '</span> + encodeUrl(getResourceName(req))
    }
...
<div class="dox">
<div class="summary">
<p>Get resource name for the request.</p>
</div>
<div class="body">
<p>This is typically just the original pathname of the request
but will fallback to &quot;resource&quot; is that cannot be determined.</p>
</div>
<div class="details">
<div class="dox_tag_title">Params</div>
<div class="dox_tag_detail">
...
<span class="dox_type">string</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getResourceName</span> (<span class="hljs-params">req</span>) </span>{
  <span class="hljs-keyword">try</span> {
    <span class="hljs-keyword">return</span> parseUrl.original(req).pathname
...
<p>security headers</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    res.setHeader(<span class="hljs-string">'Content-Security-Policy'</span>, <span class="hljs-string">"default-src 'none'"</span>)
