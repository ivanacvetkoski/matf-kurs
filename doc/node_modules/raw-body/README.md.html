  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h4">
        <a href="#encoding.unsupported">encoding.unsupported</a>
      </div>

      <div class="heading h4">
        <a href="#entity.too.large">entity.too.large</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#request.size.invalid">request.size.invalid</a>
      </div>

      <div class="heading h4">
        <a href="#stream.encoding.set">stream.encoding.set</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#using-with-typescript">Using with TypeScript</a>
      </div>
...
<pre><code class="sh">$ npm install raw-body
</code></pre>
...
<pre><code class="sh">$ npm install @types/node
</code></pre>
...
<div class="pilwrap" id="encoding.unsupported">
  <h4>
    <a href="#encoding.unsupported" name="encoding.unsupported" class="pilcrow"></a>
...
module.</p>
<div class="pilwrap" id="entity.too.large">
  <h4>
    <a href="#entity.too.large" name="entity.too.large" class="pilcrow"></a>
entity.too.large
  </h4>
</div>
...
<div class="pilwrap" id="request.size.invalid">
  <h4>
    <a href="#request.size.invalid" name="request.size.invalid" class="pilcrow"></a>
request.size.invalid
  </h4>
</div>
<p>This error will occur when the <code>length</code> option is specified, but the stream has
emitted more bytes.</p>
<div class="pilwrap" id="stream.encoding.set">
  <h4>
    <a href="#stream.encoding.set" name="stream.encoding.set" class="pilcrow"></a>
stream.encoding.set
  </h4>
</div>
...
<div class="pilwrap" id="using-with-typescript">
  <h3>
    <a href="#using-with-typescript" name="using-with-typescript" class="pilcrow"></a>
Using with TypeScript
  </h3>
</div>
<pre><code class="ts"><span class="hljs-keyword">import</span> * <span class="hljs-keyword">as</span> getRawBody <span class="hljs-keyword">from</span> <span class="hljs-string">'raw-body'</span>;
