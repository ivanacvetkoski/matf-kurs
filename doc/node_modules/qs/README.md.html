...
<pre><code class="javascript"><span class="hljs-keyword">var</span> oldCharset = qs.parse(<span class="hljs-string">'a=%A7'</span>, { <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> detectedAsUtf8 = qs.parse(<span class="hljs-string">'utf8=%E2%9C%93&amp;a=%C3%B8'</span>, {
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> detectedAsIso8859_1 = qs.parse(<span class="hljs-string">'a=%26%239786%3B'</span>, {
    <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span>,
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> arraysOfObjects = qs.parse(<span class="hljs-string">'a=b,c'</span>, { <span class="hljs-attr">comma</span>: <span class="hljs-literal">true</span> })
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> iso = qs.stringify({ æ: <span class="hljs-string">'æ'</span> }, { <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> numeric = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">'☺'</span> }, { <span class="hljs-attr">charset</span>: <span class="hljs-string">'iso-8859-1'</span> });
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> sentinel = qs.stringify({ <span class="hljs-attr">a</span>: <span class="hljs-string">'☺'</span> }, { <span class="hljs-attr">charsetSentinel</span>: <span class="hljs-literal">true</span> });
