...
<span class="hljs-keyword">var</span> toIdentifier = <span class="hljs-built_in">require</span>(<span class="hljs-string">'toidentifier'</span>)
...
<div class="dox">
<div class="summary">
<p>Set the name of a function, if possible.</p>
</div>
<div class="body">
</div>
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">nameFunc</span> (<span class="hljs-params">func, name</span>) </span>{
  <span class="hljs-keyword">var</span> desc = <span class="hljs-built_in">Object</span>.getOwnPropertyDescriptor(func, <span class="hljs-string">'name'</span>)

  <span class="hljs-keyword">if</span> (desc &amp;&amp; desc.configurable) {
    desc.value = name
    <span class="hljs-built_in">Object</span>.defineProperty(func, <span class="hljs-string">'name'</span>, desc)
  }
}
