...
<p>call to self as log</p>
  ...
  deprecate<span class="hljs-function">.<span class="hljs-keyword">function</span> = <span class="hljs-title">wrapfunction</span>
  <span class="hljs-title">deprecate</span>.<span class="hljs-title">property</span> = <span class="hljs-title">wrapproperty</span>

  <span class="hljs-title">return</span> <span class="hljs-title">deprecate</span>
}
...
<p>convert data descriptor</p>
  ...
  var <span class="hljs-keyword">set</span> = descriptor.<span class="hljs-keyword">set</span>
...
<p>wrap getter</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-keyword">get</span> === 'function') {
    descriptor.get = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getter</span> (<span class="hljs-params"></span>) </span>{
      ...
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">get</span>.apply(this, arguments)
    }
  }
...
<p>wrap setter</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-keyword">set</span> === 'function') {
    descriptor.set = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">setter</span> (<span class="hljs-params"></span>) </span>{
      log.call(deprecate, message, site)
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">set</span>.apply(this, arguments)
    }
  }
