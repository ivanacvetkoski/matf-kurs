...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/js-tokens/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#jstokens">jsTokens</a>
      </div>

      <div class="heading h3">
        <a href="#var-token-matchtotoken-match">var token = matchToToken(match)</a>
      </div>

      <div class="heading h1">
        <a href="#ecmascript-support">ECMAScript support</a>
      </div>

      <div class="heading h1">
        <a href="#invalid-code-handling">Invalid code handling</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#template-string-interpolation">Template string interpolation</a>
      </div>

      <div class="heading h3">
        <a href="#division-and-regex-literals-collision">Division and regex literals collision</a>
      </div>

      <div class="heading h3">
        <a href="#es2018">ES2018</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="overview">
  <h1>
    <a href="#overview" name="overview" class="pilcrow"></a>
Overview <a href="https://travis-ci.org/lydell/js-tokens"><img src="https://travis-ci.org/lydell/js-tokens.svg?branch=master" alt="Build Status"></a>
  </h1>
</div>
<p>A regex that tokenizes JavaScript.</p>
<pre><code class="js"><span class="hljs-keyword">var</span> jsTokens = <span class="hljs-built_in">require</span>(<span class="hljs-string">"js-tokens"</span>).default
...
<div class="pilwrap" id="jstokens">
  <h3>
    <a href="#jstokens" name="jstokens" class="pilcrow"></a>
<code>jsTokens</code>
  </h3>
</div>
...
<div class="pilwrap" id="var-token-matchtotoken-match">
  <h3>
    <a href="#var-token-matchtotoken-match" name="var-token-matchtotoken-match" class="pilcrow"></a>
<code>var token = matchToToken(match)</code>
  </h3>
</div>
<pre><code class="js"><span class="hljs-keyword">import</span> {matchToToken} <span class="hljs-keyword">from</span> <span class="hljs-string">"js-tokens"</span>
<span class="hljs-comment">// or:</span>
...
<div class="pilwrap" id="ecmascript-support">
  <h1>
    <a href="#ecmascript-support" name="ecmascript-support" class="pilcrow"></a>
ECMAScript support
  </h1>
</div>
...
<div class="pilwrap" id="invalid-code-handling">
  <h1>
    <a href="#invalid-code-handling" name="invalid-code-handling" class="pilcrow"></a>
...
the <a href="#es2018.html">ES2018</a> section.</p>
...
<div class="pilwrap" id="template-string-interpolation">
  <h3>
    <a href="#template-string-interpolation" name="template-string-interpolation" class="pilcrow"></a>
...
supported.</p>
<div class="pilwrap" id="division-and-regex-literals-collision">
  <h3>
    <a href="#division-and-regex-literals-collision" name="division-and-regex-literals-collision" class="pilcrow"></a>
Division and regex literals collision
  </h3>
</div>
<p>Consider this example:</p>
<pre><code class="js"><span class="hljs-keyword">var</span> g = <span class="hljs-number">9.82</span>
...
look backwards. See the <a href="#es2018.html">ES2018</a> section).</p>
...
<pre><code class="js">/ <span class="hljs-number">2</span>/g
</code></pre>
...
<pre><code class="js">foo /= <span class="hljs-number">2</span>/g
...
<pre><code class="js"><span class="hljs-keyword">var</span> foo = <span class="hljs-number">2</span>/g
...
<pre><code class="js"><span class="hljs-keyword">var</span> number = bar / <span class="hljs-number">2</span>/e
</code></pre>
...
code).</p>
<div class="pilwrap" id="es2018">
  <h3>
    <a href="#es2018" name="es2018" class="pilcrow"></a>
ES2018
  </h3>
</div>
