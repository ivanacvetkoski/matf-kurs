...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">main</span> (<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">var</span> options = { <span class="hljs-attr">loose</span>: loose, <span class="hljs-attr">includePrerelease</span>: includePrerelease }

  versions = versions.map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">v</span>) </span>{
    <span class="hljs-keyword">return</span> coerce ? (semver.coerce(v) || { <span class="hljs-attr">version</span>: v }).version : v
