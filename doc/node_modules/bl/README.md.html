...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#bl.indexof-value-byteoffset-encoding">bl.indexOf(value[, byteOffset][, encoding])</a>
      </div>
...
bl.append(Buffer.from(<span class="hljs-string">'abcd'</span>))
bl.append(Buffer.from(<span class="hljs-string">'efg'</span>))
bl.append(<span class="hljs-string">'hi'</span>)                     <span class="hljs-comment">// bl will also accept &amp; convert Strings</span>
bl.append(Buffer.from(<span class="hljs-string">'j'</span>))
bl.append(Buffer.from([ <span class="hljs-number">0x3</span>, <span class="hljs-number">0x4</span> ]))
...
<span class="hljs-built_in">console</span>.log(bl.indexOf(<span class="hljs-string">'def'</span>)) <span class="hljs-comment">// 3</span>
<span class="hljs-built_in">console</span>.log(bl.indexOf(<span class="hljs-string">'asdf'</span>)) <span class="hljs-comment">// -1</span>
...
bl.append(Buffer.from(<span class="hljs-string">'abcd'</span>))
bl.append(Buffer.from(<span class="hljs-string">'efg'</span>))
bl.append(Buffer.from(<span class="hljs-string">'hi'</span>))
bl.append(Buffer.from(<span class="hljs-string">'j'</span>))
...
<li><a href="#indexOf"><code>bl.<b>indexOf(value[, byteOffset][, encoding])</b></code></a></li>
...
<hr>
<p><a name="indexOf"></a></p>
<div class="pilwrap" id="bl.indexof-value-byteoffset-encoding">
  <h3>
    <a href="#bl.indexof-value-byteoffset-encoding" name="bl.indexof-value-byteoffset-encoding" class="pilcrow"></a>
bl.indexOf(value[, byteOffset][, encoding])
  </h3>
</div>
<p><code>get()</code> will return the byte at the specified index.
<code>indexOf()</code> method returns the first index at which a given element can be found in the BufferList, or -1 if it is not present.</p>
<hr>
<p><a name="slice"></a></p>
...
<p>Copyright (c) 2013-2018 bl contributors (listed above).</p>
